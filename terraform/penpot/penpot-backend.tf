resource "kubernetes_config_map" "penpot_backend_env" {
  ...
  data = {
    ...
    PENPOT_OIDC_BASE_URI  = "${data.terraform_remote_state.keycloak_config.outputs.keycloak_issuer_url}/"
    # PENPOT_OIDC_AUTH_URI  = data.terraform_remote_state.keycloak_config.outputs.keycloak_auth_url
    # PENPOT_OIDC_TOKEN_URI = data.terraform_remote_state.keycloak_config.outputs.keycloak_token_url
    # PENPOT_OIDC_USER_URI  = data.terraform_remote_state.keycloak_config.outputs.keycloak_api_url
    # PENPOT_OIDC_ROLES      = ""
